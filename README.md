...
<a href="https://salonyranjan.github.io/neural-map/" target="_blank">
  <img src="./assets/demo.gif" alt="Neural Map — 3D Knowledge Graph Demo" width="100%" style="border-radius:16px; box-shadow: 0 0 60px #c8ff0055, 0 0 120px #38bdf840;" />
</a>

<br/><br/>

<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=900&size=20&pause=1000&color=c8ff00&center=true&vCenter=true&width=980&height=55&lines=🌐+3D+Force-Directed+Knowledge+Graph+%7C+60+FPS+rAF+Loop;🔗+23+Projects+·+17+Live+Demos+·+6+Domains+·+Real-Time+Physics;🔍+Live+Search+%7C+Category+Filter+%7C+Complexity-Weighted+Nodes;⚡+Vanilla+Three.js+r128+%7C+Zero+npm+%7C+Single+HTML+File" alt="Typing SVG" />

<br/><br/>

<!-- ── Badges Row 1 — Status ── -->
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-c8ff00?style=for-the-badge&logoColor=black)](https://salonyranjan.github.io/neural-map/)
[![Version](https://img.shields.io/badge/version-v1.0.0-38bdf8?style=for-the-badge)](https://github.com/salonyranjan/neural-map/releases)
[![License](https://img.shields.io/badge/license-MIT-ff6e3c?style=for-the-badge)](LICENSE)
[![Stars](https://img.shields.io/github/stars/salonyranjan/neural-portfolio?style=for-the-badge&color=c8ff00)](https://github.com/salonyranjan/neural-portfolio/stargazers)

<br/>

<!-- ── Badges Row 2 — Tech ── -->
<img src="https://img.shields.io/badge/Three.js-r128-000000?style=for-the-badge&logo=three.js&logoColor=white" />
<img src="https://img.shields.io/badge/Vanilla_JS-ES2020+-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black" />
<img src="https://img.shields.io/badge/WebGL-GPU_Compositing-c8ff00?style=for-the-badge&logoColor=black" />
<img src="https://img.shields.io/badge/Custom_Physics-Force_Sim-38bdf8?style=for-the-badge" />
<img src="https://img.shields.io/badge/GitHub_Pages-Deployed-181717?style=for-the-badge&logo=github&logoColor=white" />

<br/>

<!-- ── Badges Row 3 — Stats ── -->
<img src="https://img.shields.io/badge/23_Projects-ff6e3c?style=for-the-badge" />
<img src="https://img.shields.io/badge/17_Live_Demos-38bdf8?style=for-the-badge" />
<img src="https://img.shields.io/badge/6_Domains-a3e635?style=for-the-badge" />
<img src="https://img.shields.io/badge/0_npm_packages-c8ff00?style=for-the-badge" />
<img src="https://img.shields.io/badge/~260KB_Bundle-fbbf24?style=for-the-badge" />

<br/>

<img src="https://img.shields.io/github/forks/salonyranjan/neural-portfolio?style=for-the-badge&color=f472b6" />
<img src="https://img.shields.io/github/issues/salonyranjan/neural-portfolio?style=for-the-badge&color=38bdf8" />
<img src="https://img.shields.io/github/last-commit/salonyranjan/neural-portfolio?style=for-the-badge&color=c8ff00" />
...
<a href="https://salonyranjan.github.io/neural-map/"><img src="https://img.shields.io/badge/🌐_Launch_Graph-c8ff00?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#10--getting-started"><img src="https://img.shields.io/badge/📦_Quick_Start-38bdf8?style=for-the-badge" /></a>
&nbsp;
<a href="#5--architecture"><img src="https://img.shields.io/badge/🏗️_Architecture-ff6e3c?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#9--roadmap"><img src="https://img.shields.io/badge/🗺️_Roadmap-a3e635?style=for-the-badge&logoColor=black" /></a>
...
<div align="center">
  <img src="./assets/search.png" width="400" alt="Neural Map — Live Search"/>
...
<div align="center">
  <img src="./assets/sidebar.png" width="350" alt="Neural Map — Project Panel"/>
...
graph TD
    ...
    subgraph Physics ["⚛️ Physics Layer — Custom Force Sim"]
        FORCE["🌀 runForce(150 steps)\nPre-baked Simulation"]
        REP["↔️ Repulsion\nCoulomb O(n²)"]
        ATT["🔗 Attraction\nHooke's Law"]
        GRAV["🌍 Gravity\nCenter Pull + Damping"]
        LINKS["🔗 LINKS Array\nSame-Category + Cross-Edges"]
    end

    subgraph Render ["🌐 Render Layer — Three.js r128"]
        SPHERE["🔵 SphereGeometry\nNode Meshes"]
        TORUS["🌀 TorusGeometry\nOrbiting Rings"]
        GLOW["✨ Glow Halos\nAdditive Blend"]
        LINES["〰️ LineSegments x2\nEdge Layers"]
        PLEXUS["🌌 Points + Lines\nNeural Plexus"]
        LABELS["🏷️ Sprites\nFloating Labels"]
        LIGHTS["💡 4x PointLights\nDynamic Lighting"]
    end

    subgraph Interaction ["🖱️ Interaction Layer"]
        RAY["🎯 Raycaster\nHover Detection"]
        SEARCH["🔍 Live Search\nOpacity Fade"]
    ...
    FORCE --> REP & ATT & GRAV
    FORCE --> LINKS
    LINKS --> SPHERE & TORUS & GLOW & LINES & PLEXUS & LABELS & LIGHTS
    Render --> RAY --> SEARCH & LEGEND & PANEL

    classDef data fill:#0a0a00,stroke:#c8ff00,stroke-width:2px,color:#fff;
    classDef physics fill:#000a1a,stroke:#38bdf8,stroke-width:2px,color:#fff;
    classDef render fill:#0a0500,stroke:#ff6e3c,stroke-width:2px,color:#fff;
    classDef interact fill:#0a000a,stroke:#f472b6,stroke-width:2px,color:#fff;

    class RAW,CATS,CL data;
    class FORCE,REP,ATT,GRAV,LINKS physics;
    class SPHERE,TORUS,GLOW,LINES,PLEXUS,LABELS,LIGHTS render;
    class RAY,SEARCH,LEGEND,PANEL interact;
```
...
```mermaid
flowchart LR
    subgraph Ingest ["📦 INGEST — Data Layer"]
        RAW["📋 RAW Array"] -->|name + score| CL["🔍 classify()"]
        CL -->|category tag| CATS["🎨 CATS Config"]
        CATS -->|color + radius| CS["📊 Complexity Score\nNode Size Mapping"]
    end

    subgraph Transform ["⚛️ TRANSFORM — Physics"]
        CS -->|nodes| NB["🔵 Node Builder\nxyz positions"]
        CS -->|shared category| EB["🔗 Edge Builder\nLINKS array"]
        NB & EB -->|150 pre-baked steps| FD["🌀 runForce()\nForce Simulation"]
    end

    subgraph Render ["🌐 RENDER — Three.js"]
        FD -->|settled positions| SC["🌌 Scene Build"]
        SC -->|60 FPS rAF| WGL["🖥️ WebGL Canvas"]
        WGL -->|click / hover| UI["📊 UI Layer\nTooltip + Panel"]
    end
```
...
sequenceDiagram
    ...
    participant PH as ⚛️ Physics Engine
    participant R3  as 🌐 Three.js Scene

    Note over U,B: 🚀 Initial Load
    U->>B: Open index.html
    B->>PH: runForce(150 steps) — pre-bake
    PH-->>B: Settled node positions
    B->>R3: Build scene — nodes, rings, edges, plexus
    R3-->>U: 3D graph renders at 60 FPS ✅

    Note over U,R3: 🔍 Search Interaction
    U->>B: Type in search bar
    B->>R3: Filter nodes — fade non-matches
    R3-->>U: Matching nodes highlighted in real time

    Note over U,R3: 🎨 Category Filter
    U->>B: Click legend item
    B->>R3: Isolate category nodes
    R3-->>U: Other domains fade · category cluster visible

    Note over U,R3: 📊 Node Click → Panel
    U->>R3: Click node
    R3-->>U: Project panel opens
    B->>B: Route to live demo or GitHub CTA
    B-->>U: "View Live Demo" highlighted ✅
```
...
<p>
  <img src="https://img.shields.io/badge/Three.js-r128-000000?style=for-the-badge&logo=three.js&logoColor=white" />
  <img src="https://img.shields.io/badge/Vanilla_JS-ES2020+-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black" />
  <img src="https://img.shields.io/badge/WebGL-GPU_Rendering-c8ff00?style=for-the-badge&logoColor=black" />
  <img src="https://img.shields.io/badge/Syne-Typography-38bdf8?style=for-the-badge" />
  <img src="https://img.shields.io/badge/DM_Mono-Monospace-ff6e3c?style=for-the-badge" />
  <img src="https://img.shields.io/badge/GitHub_Pages-Deploy-181717?style=for-the-badge&logo=github&logoColor=white" />
</p>
...
| 🛠️ Tool | 📌 Version | 🔗 Link |
|:---|:---:|:---|
| ![Browser](https://img.shields.io/badge/Browser-Any_Modern-38bdf8?style=flat&logo=googlechrome&logoColor=white) | Chrome / Firefox / Safari / Edge | — |
...
<table style="border:none;">
  <tr>
    <td align="center" style="border:none;" width="160">
      <img src="https://github.com/salonyranjan.png" width="145" style="border-radius:50%; border:3px solid #c8ff00; box-shadow:0 0 25px #c8ff00, 0 0 50px #38bdf840;" alt="Salony Ranjan" />
    </td>
    <td style="border:none; padding-left:22px;">
      ...
      &nbsp;
      <a href="https://salonyranjan.github.io/neural-map/"><img src="https://img.shields.io/badge/Neural_Map-c8ff00?style=for-the-badge&logo=three.js&logoColor=black" /></a>
    </td>
  </tr>
</table>
...
<a href="https://github.com/salonyranjan/neural-portfolio/stargazers"><img src="https://img.shields.io/badge/⭐_Star_This_Repo-c8ff00?style=for-the-badge&logo=github&logoColor=black" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/neural-portfolio/fork"><img src="https://img.shields.io/badge/🍴_Fork_&_Build-38bdf8?style=for-the-badge&logo=github&logoColor=black" /></a>
&nbsp;
<a href="https://salonyranjan.github.io/neural-map/"><img src="https://img.shields.io/badge/🌐_View_Live-ff6e3c?style=for-the-badge&logoColor=white" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/neural-portfolio/issues/new"><img src="https://img.shields.io/badge/💡_Feature_Request-a3e635?style=for-the-badge&logoColor=black" /></a>

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:c8ff00,35:38bdf8,70:ff6e3c,100:000000&height=130&section=footer&animation=fadeIn" />

<br/>

*Built with* 🌐 *by* [**Salony Ranjan**](https://github.com/salonyranjan) &nbsp;·&nbsp; *© 2026 Neural Map · MIT*

<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=600&size=13&duration=4000&pause=1000&color=c8ff00&center=true&vCenter=true&width=580&lines=SYSTEM+STATUS%3A+GRAPH+ENGINE+ONLINE+🌐;60+FPS+%7C+FORCE+SIMULATION+ACTIVE+⚡;STAY+CURIOUS+·+BUILD+·+CONNECT+THE+DOTS" />

<img src="https://komarev.com/ghpvc/?username=salonyranjan&label=PROFILE+VIEWS&color=c8ff00&style=for-the-badge" />
